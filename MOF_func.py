...
def gen_df_all_iy_by_xlsx_reports_version_1(df_all_iy_xlsx):
    # # 測試用
...
def gen_df_all_iy_xlsx_by_reports_version_2(df_all_iy_xlsx):
    ...
    df.rename(columns={'industry': 'industry_original', 'reports_version_2_ind_name': 'industry'}, inplace=True)
    return df
